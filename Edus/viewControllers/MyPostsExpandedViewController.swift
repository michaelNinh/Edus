//
//  MyPostsExpandedViewController.swift
//  Edus
//
...
class MyPostsExpandedPostViewController: UIViewController, TimelineComponentTarget, ShowFlagAlertForReplyPost {
    ...
    var timelineComponent: TimelineComponent<ReplyPost, MyPostsExpandedPostViewController>!
    ...
    @IBAction func unwindToMyExpandedPost(segue: UIStoryboardSegue) {
    }
...
extension MyPostsExpandedPostViewController: UITableViewDelegate{
...
extension MyPostsExpandedPostViewController{
...
extension MyPostsExpandedPostViewController: UITableViewDataSource {
