...
class MyPostsViewController: UIViewController, TimelineComponentTarget, ShowFlagAlertFromUserPost {
    ...
    var timelineComponent: TimelineComponent<Post, MyPostsViewController>!
    ...
    func loadInRange(range: Range<Int>, completionBlock: ([Post]?) -> Void) {
        ...
        GetPostsFromUserForClass.getPostsForClass({ (result: [PFObject]?, error: NSError?) -> Void in
...
extension MyPostsViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("postCell") as! ClassPostFromUserTableViewCell
